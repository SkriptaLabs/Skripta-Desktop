...
const levelStyles = {
  1: {
    ...
    inactive: "text-foreground/60 hover:text-foreground hover:bg-muted/50",
  },
  2: {
    bar: "border-b border-border/60",
    button: "text-xs px-3 py-1.5",
    active: "bg-muted/70 font-medium",
    inactive: "text-foreground/50 hover:text-foreground/80 hover:bg-muted/30",
  },
  3: {
    bar: "border-b border-border/40",
    button: "text-xs px-2 py-1",
    active: "bg-muted/50 font-medium",
    inactive: "text-foreground/40 hover:text-foreground/70 hover:bg-muted/20",
  },
};
